        ...
        <div class="col-md-12">
          <form class="" action="edit.php" method="post" data-toggle="validator"> 
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="published_date" value="<?php echo $news['published_date'];?>" data-error="請選擇日期" required>
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
              <input type="text" class="form-control"  name="title" value="<?php echo $news['title'];?>" data-error="請填寫標題" required>
              <div class="help-block with-errors alert-danger"></div>
              </div>
            </div>
            <div class="form-group form-row">
