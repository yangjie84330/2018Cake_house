...
$query = $db->query("SELECT * FROM page ORDER BY page_id ASC LIMIT ".$start_from.",".$limit);
    ...
    <div class="container">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="edit.php?page_id=<?php echo $pages['page_id']; ?>" class="btn btn-outline-primary">編輯</a>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <?php  if($total_rows > 0){
                $sth = $db->query("SELECT * FROM page ORDER BY page_id ASC");
